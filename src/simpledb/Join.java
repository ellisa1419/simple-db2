...
public class Join extends AbstractDbIterator {
	...
	protected Tuple readNext() throws TransactionAbortedException, DbException {
		...
		while(t1!=null || child1.hasNext()){ // as long as child 1 has more tuples
			if(t1==null){
				t1=child1.next();
			}
			while(child2.hasNext()){ // for every right child
				Tuple t2=child2.next(); 
				if(p.filter(t1, t2)){   // compare tuple 1 with 2
					return concatenate(t1, t2); // return if same
				}
			}
			t1=null;
			child2.rewind(); // start over
		}
		return null;
		}
